        ...
        return (
            ...
            <Tab.Navigator
                ...
                <Tab.Screen name="Updates" component={Updates}
                    ...
                    options={{
                        ...
                        tabBarIcon: ({ color, size }) => (
                           <Image source={require('../App/assets/campaign_black_24dp.png')}/>
                        ),
                    }} />
                <Tab.Screen name="Wineries" component={Wineries}
                    options={{
                        tabBarLabel: 'Wineries',
                        tabBarIcon: ({ color, size }) => (
                            <Image source={require('../App/assets/wine_bar_black_24dp.png')}/>
                        ),
                    }}
                />
                <Tab.Screen name="Home" component={Home}
                    ...
                    <Tab.Screen name="Price List" component={PriceList}
                    options={{
                        tabBarLabel: 'Price List',
                        
                        tabBarIcon: ({ color, size }) => (
                            <Image source={require('../App/assets/inventory_2_black_24dp.png')}/>
                        ),
                    }} />
                    ...
                    options={{
                        ...
                        tabBarIcon: ({ color, size }) => (
                            <Image source={require('../App/assets/person_outline_black_24dp.png')}/>
                        ),
                    }} />
            </Tab.Navigator>
            </SafeAreaView>
